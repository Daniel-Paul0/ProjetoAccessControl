...
public class Client {
    ...
    private GUITerminalWithPin gui;
    ...
    private void handleChallenge(JsonObject message) throws CardException {
        ...
        String encryptedHex = bytesToHex(encryptedChallengeCard);
    ...
    public void init(GUITerminalWithPin gui) {
        this.gui = gui;
        // initialize reader
        ...
        while (true) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                this.response = cardChannel.transmit(verifyPIN);

                if (this.response.getSW() == 0x9000) {
                    pinVerify = true;
                    break;
                } else {
